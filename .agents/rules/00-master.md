...
> **Tipo**: `rule` | **Versión**: 3.1.5 | **Prioridad**: MÁXIMA
...
Este archivo define la identidad, propósito y reglas fundamentales de **LMAgent v3.1.5**. Antes de implementar cualquier cambio:
