...
| Principio | Regla |
|-----------|-------|
| **00-master.md** | ⭐ Entry point: startup, skills, reglas críticas |
| **01-workflow.md** | Git flow, niveles de complejidad, flujo de trabajo |
| **02-tech-stack.md** | Stack tecnológico aprobado y librerías autorizadas |
| **03-code-style.md** | Linter, naming conventions, estructura de proyecto |
| **04-security.md** | Validación de inputs, gestión de secretos, OWASP Top 10 |
| **05-testing.md** | TDD obligatorio, requisitos de cobertura |
| **06-api-design.md** | Estándares REST/GraphQL, error handling, versionado |
| **07-documentation.md** | ⚠️ Documentación continua, READMEs, ADRs |
| **09-automations.md** | Best practices para workflows n8n robustos |
| **10-git-flow.md** | Gestión de ramas, commits y PRs |
